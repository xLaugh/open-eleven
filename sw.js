/* ============================================================
   ...
   ============================================================ */
const CACHE = "open-eleven-v10.40";
const CORE = [
  "./", "./index.html",
  "./style.css?v=10.40", "./data.js?v=10.40", "./engine.js?v=10.40", "./game.js?v=10.40", "./i18n-boot.js?v=10.40", "./i18n-data.js?v=10.40", "./i18n.js?v=10.40", "./sw-register.js?v=10.40",
  "./src/vendor/supabase.js?v=10.40", "./src/supabase-config.js?v=10.40", "./src/badwords.js?v=10.40", "./account.js?v=10.40",

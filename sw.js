/* ============================================================
   ...
   ============================================================ */
const CACHE = "open-eleven-v10.11";
const CORE = [
  "./", "./index.html",
  "./style.css?v=10.11", "./data.js?v=10.11", "./engine.js?v=10.11", "./game.js?v=10.11",
  "./src/vendor/supabase.js?v=10.11", "./src/supabase-config.js?v=10.11", "./account.js?v=10.11",

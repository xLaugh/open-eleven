/* ============================================================
   ...
   ============================================================ */
const CACHE = "open-eleven-v10.17";
const CORE = [
  "./", "./index.html",
  "./style.css?v=10.17", "./data.js?v=10.17", "./engine.js?v=10.17", "./game.js?v=10.17",
  "./src/vendor/supabase.js?v=10.17", "./src/supabase-config.js?v=10.17", "./account.js?v=10.17",

/* ============================================================
   ...
   ============================================================ */
const CACHE = "open-eleven-v10.14";
const CORE = [
  "./", "./index.html",
  "./style.css?v=10.14", "./data.js?v=10.14", "./engine.js?v=10.14", "./game.js?v=10.14",
  "./src/vendor/supabase.js?v=10.14", "./src/supabase-config.js?v=10.14", "./account.js?v=10.14",

/* ============================================================
   ...
   ============================================================ */
const CACHE = "open-eleven-v10.9";
const CORE = [
  "./", "./index.html",
  "./style.css?v=10.9", "./data.js?v=10.9", "./engine.js?v=10.9", "./game.js?v=10.9",
  "./src/vendor/supabase.js?v=10.9", "./src/supabase-config.js?v=10.9", "./account.js?v=10.9",

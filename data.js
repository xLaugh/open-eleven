...
const CLUBS = [
  ...
  { id: "ir_chiraz", name: "Chiraz", level: "d1", countryId: "ir", colors: "🟢⚪" },
  { id: "ir_machhad", name: "Machhad", level: "d1", countryId: "ir", colors: "🟡⚫" },
  ...
  { id: "at_linz", name: "Linz", level: "d1", countryId: "at", colors: "⚫⚪" },
  { id: "at_innsbruck", name: "Innsbruck", level: "d1", countryId: "at", colors: "🟢⚪" },
  { id: "ec_quito", name: "Quito", level: "d1", countryId: "ec", colors: "🔵⚪" },
  { id: "ec_guayaquil", name: "Guayaquil", level: "d1", countryId: "ec", colors: "🟡⚫" },
  { id: "ec_cuenca", name: "Cuenca", level: "d1", countryId: "ec", colors: "🔴⚪" },
  { id: "ec_ambato", name: "Ambato", level: "d1", countryId: "ec", colors: "🔴🔵" },
  { id: "ec_manta", name: "Manta", level: "d1", countryId: "ec", colors: "🟢⚪" },
  ...
  { id: "ua_dnipro", name: "Dnipro", level: "d1", countryId: "ua", colors: "🔵⚪" },
  { id: "ua_odessa", name: "Odessa", level: "d1", countryId: "ua", colors: "⚫🟡" },
  ...
  { id: "ru_sotchi", name: "Sotchi", level: "d1", countryId: "ru", colors: "⚫🔵" },
  { id: "ru_rostov", name: "Rostov", level: "d1", countryId: "ru", colors: "🟡🔵" },
  { id: "wal_cardiff", name: "Cardiff", level: "d1", countryId: "wal", colors: "🔵⚪" },
  { id: "wal_swansea", name: "Swansea", level: "d1", countryId: "wal", colors: "⚪⚫" },
  { id: "wal_newport", name: "Newport", level: "d1", countryId: "wal", colors: "🟡⚫" },
  { id: "wal_merthyr", name: "Merthyr", level: "d1", countryId: "wal", colors: "🔴⚪" },
  { id: "wal_bangor", name: "Bangor", level: "d1", countryId: "wal", colors: "🔵⚫" },
  ...
  { id: "rs_kragujevac", name: "Kragujevac", level: "d1", countryId: "rs", colors: "🔴⚫" },
  { id: "rs_subotica", name: "Subotica", level: "d1", countryId: "rs", colors: "🟡🔵" },
  ...
  { id: "hu_gyor", name: "Győr", level: "d1", countryId: "hu", colors: "🟢⚫" },
  { id: "hu_pecs", name: "Pécs", level: "d1", countryId: "hu", colors: "🔴🔵" },
  ...
  { id: "sco_dundee", name: "Dundee", level: "d1", countryId: "sco", colors: "🔵⚪" },
  { id: "sco_inverness", name: "Inverness", level: "d1", countryId: "sco", colors: "🔵🔴" },
  { id: "ie_dublin", name: "Dublin", level: "d1", countryId: "ie", colors: "🔵⚪" },
  { id: "ie_cork", name: "Cork", level: "d1", countryId: "ie", colors: "🔴⚪" },
  { id: "ie_limerick", name: "Limerick", level: "d1", countryId: "ie", colors: "🟢⚪" },
  { id: "ie_galway", name: "Galway", level: "d1", countryId: "ie", colors: "🟤⚪" },
  { id: "ie_waterford", name: "Waterford", level: "d1", countryId: "ie", colors: "🔵⚫" },
  { id: "nir_belfast", name: "Belfast", level: "d1", countryId: "nir", colors: "🔴⚪" },
  { id: "nir_derry", name: "Derry", level: "d1", countryId: "nir", colors: "🔴⚪" },
  { id: "nir_lisburn", name: "Lisburn", level: "d1", countryId: "nir", colors: "🔵⚪" },
  { id: "nir_newry", name: "Newry", level: "d1", countryId: "nir", colors: "🟡⚫" },
  { id: "nir_armagh", name: "Armagh", level: "d1", countryId: "nir", colors: "🟠⚫" },
  { id: "ve_caracas", name: "Caracas", level: "d1", countryId: "ve", colors: "🔴⚪" },
  { id: "ve_maracaibo", name: "Maracaibo", level: "d1", countryId: "ve", colors: "🔵⚫" },
  { id: "ve_barquisimeto", name: "Barquisimeto", level: "d1", countryId: "ve", colors: "🔴⚫" },
  { id: "ve_maracay", name: "Maracay", level: "d1", countryId: "ve", colors: "🟡🔵" },
  { id: "ve_barinas", name: "Barinas", level: "d1", countryId: "ve", colors: "🟢⚪" },
  ...
  { id: "cz_plzen", name: "Plzeň", level: "d1", countryId: "cz", colors: "🔴🔵" },
  { id: "cz_liberec", name: "Liberec", level: "d1", countryId: "cz", colors: "🔵⚪" },
  ...
  { id: "eg_ismailia", name: "Ismaïlia", level: "d1", countryId: "eg", colors: "🟢⚪" },
  { id: "eg_portsaid", name: "Port-Saïd", level: "d1", countryId: "eg", colors: "🟢🔴" },
  ...
  { id: "za_durban", name: "Durban", level: "d1", countryId: "za", colors: "🔵⚪" },
  { id: "za_soweto", name: "Soweto", level: "d1", countryId: "za", colors: "🔴⚪" },
  ...
  { id: "ba_tuzla", name: "Tuzla", level: "d1", countryId: "ba", colors: "🔵🟡" },
  { id: "ba_zenica", name: "Zenica", level: "d1", countryId: "ba", colors: "🟣⚪" },
  { id: "py_asuncin", name: "Asunción", level: "d1", countryId: "py", colors: "🔴🔵" },
  { id: "py_ciudaddeleste", name: "Ciudad del Este", level: "d1", countryId: "py", colors: "🟢⚪" },
  { id: "py_luque", name: "Luque", level: "d1", countryId: "py", colors: "🔵🟡" },
  { id: "py_lambare", name: "Lambaré", level: "d1", countryId: "py", colors: "🔵⚪" },
  { id: "py_encarnacin", name: "Encarnación", level: "d1", countryId: "py", colors: "🔴⚪" },
  ...
  { id: "cl_antofagasta", name: "Antofagasta", level: "d1", countryId: "cl", colors: "🔵🟡" },
  { id: "cl_laserena", name: "La Serena", level: "d1", countryId: "cl", colors: "🔴🟡" },
  { id: "ca_toronto", name: "Toronto", level: "d1", countryId: "ca", colors: "🔴⚪" },
  { id: "ca_montral", name: "Montréal", level: "d1", countryId: "ca", colors: "🔵⚫" },
  { id: "ca_vancouver", name: "Vancouver", level: "d1", countryId: "ca", colors: "🔵🟢" },
  { id: "ca_ottawa", name: "Ottawa", level: "d1", countryId: "ca", colors: "🔴⚫" },
  { id: "ca_calgary", name: "Calgary", level: "d1", countryId: "ca", colors: "🔴🟡" },
  { id: "sv_sansalvador", name: "San Salvador", level: "d1", countryId: "sv", colors: "🔵⚪" },
  { id: "sv_santaana", name: "Santa Ana", level: "d1", countryId: "sv", colors: "🔴⚪" },
  { id: "sv_sanmiguel", name: "San Miguel", level: "d1", countryId: "sv", colors: "🟢⚪" },
  { id: "sv_sonsonate", name: "Sonsonate", level: "d1", countryId: "sv", colors: "🟡🔵" },
  { id: "sv_lalibertad", name: "La Libertad", level: "d1", countryId: "sv", colors: "🔵🟡" },
  { id: "ao_luanda", name: "Luanda", level: "d1", countryId: "ao", colors: "🔴⚫" },
  { id: "ao_huambo", name: "Huambo", level: "d1", countryId: "ao", colors: "🔵⚪" },
  { id: "ao_lobito", name: "Lobito", level: "d1", countryId: "ao", colors: "🟢⚪" },
  { id: "ao_benguela", name: "Benguela", level: "d1", countryId: "ao", colors: "🟡🔴" },
  { id: "ao_namibe", name: "Namibe", level: "d1", countryId: "ao", colors: "🔵🟡" },
  { id: "mg_antananarivo", name: "Antananarivo", level: "d1", countryId: "mg", colors: "🔴⚪" },
  { id: "mg_toamasina", name: "Toamasina", level: "d1", countryId: "mg", colors: "🔵🟡" },
  { id: "mg_antsirabe", name: "Antsirabe", level: "d1", countryId: "mg", colors: "🟢⚪" },
  { id: "mg_mahajanga", name: "Mahajanga", level: "d1", countryId: "mg", colors: "🟠⚫" },
  { id: "mg_fianarantsoa", name: "Fianarantsoa", level: "d1", countryId: "mg", colors: "🔴🟢" },
  ...
  { id: "ng_ibadan", name: "Ibadan", level: "d1", countryId: "ng", colors: "🟡⚫" },
  { id: "ng_enugu", name: "Enugu", level: "d1", countryId: "ng", colors: "🔴⚫" },
